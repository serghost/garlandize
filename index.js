exports.garlandize = function() {

    var OPTIONS = { x_gap: 45, // standart x-axis distance beetween nodes. less distance - more nodes
                    x_rand: 25, // random addition (0..25)
                    angle_rand: 10, // random angle of node (0..25)
                    amplitude: 4, // 1 to xxx. greater values == smoother distribution
                    frequency: 100, // 1 to xxx. 
                                        
                    // arrangementFunction: "Math.cos",
                    ...
                    cordStroke: { color: "black", width: "2", dasharray: "0" }
                  };

    
    var element = document.querySelector('.garlandize');
